<body class="bg-gradient-success">
            ...
            <div class="p-5">
              ...
              <form action="" class="user"  method="post">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="birthdate" class="form-control form-control-user" placeholder="Fecha Nacimiento yyyy-mm-dd" required> 
                  </div>
                </div>
                <div class="form-group">
                  <input type="email" name="email" class="form-control form-control-user" placeholder="Correo Electronico" required>
                </div>
                <div class="form-group">
  ...
  <?php 
    if ($_POST) {
      ...
      if (addStudents($names, $birthdate, $email, $password, $conn)) {
