	...
	<main class="container">
		...
		<section class="row mt-5">
			...
			<div class="col-md-8 offset-md-2">
				<h1 class="text-center">"Condiconal (Switch)"</h1>
				<hr>
				<?php 
					$day = date('n');
				...
				switch ($day) {
				 	case 1:
				 		echo '<ul class="list-group">
				 			 	<li class="list-group-item
				 			 		list-group-item-secondary">Primer Trimestre</li>
				 	...
				 	case 4:
				 		echo '<ul class="list-group">
				 			 	<li class="list-group-item
				 			 		list-group-item-secondary">Segundo Trimestre</li>
				 	...
				 	case 7:
				 		echo '<ul class="list-group">
				 			 	<li class="list-group-item
				 			 		list-group-item-secondary">Tercer Trimestre</li>
				 	...
				 	default:
				 		echo '<ul class="list-group">
				 			 	<li class="list-group-item
				 			 		list-group-item-secondary">Cuarto Trimestre</li>
