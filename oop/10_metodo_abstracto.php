	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<h1 class="h3 text-center">Metodo Abstracta</h1>
				<hr>
				<ul class="list-group">
				<?php 
					...
					$vg1 = new Zelda('Zelda Ocarina of Time', 'Nintendo 64', 1998);
					...
					$vg4 = new Zelda('Zelda Breath', 'Nintendo Switch', 2007);
